...
if(isset($_SESSION["username"])){
    ...
    $type=$_SESSION["typeof_bill"];
    // echo $_SESSION["username"]; 
    if($type=="WATER"){
    $result=$con->query("SELECT * FROM customer_details where connection_id='$connection_id'") or die($mysqli->error);}
    else{
        $result=$con->query("SELECT * FROM customer_details_electricty where connection_id='$connection_id'") or die($mysqli->error);
...
if($row_2['payment']=="0" OR $row_2['status']=="not paid") {
